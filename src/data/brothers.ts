...
export const executives: Brother[] = [
  ...
  },
  {
    ...
    bio: 'Tanay is a sophomore in the Alpha Epsilon class studying in the LSBE program. He grew up in the South Bay, and now resides in San Diego. Tanay is interested in applying research into the molecular biology behind injury recovery to drive innovation within the biotech industry. He also enjoys hooping, thought-provoking movies, 80s rock, and sitcoms.',
