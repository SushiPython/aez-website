    ...
    <main>
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white">
          <h1 className="text-6xl md:text-8xl font-merriweather font-bold mb-4">Rush Timeline Fall 2026</h1>
                    ...
                    <div className="flex items-start gap-6">
                      <div className="flex-shrink-0">
                        <img
                          ...
                          alt="Tabling and Coffee Chats"
                          className="w-72 h-56 object-cover rounded-lg"
                        />
                      </div>
                      <div className="flex-1">
                        <div className="text-[#3d0f19] font-bold text-sm mb-2">8/31 - 9/8</div>
                        <h3 className="text-2xl font-merriweather font-bold mb-3">Tabling and Coffee Chats</h3>
                        <div className="text-gray-600 mb-3">Location: Various locations</div>
                        <p className="text-gray-700">
                          Come meet the brothers and learn more about AEZ throughout the first week of rush.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-gray-700">
                          Come out and meet the brothers in a more informal setting. Follow our Instagram for updates and tickets.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="ml-16 flex-1">
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        <div className="text-[#3d0f19] font-bold text-sm mb-2">9/7 | 7:00 - 8:30 PM</div>
                        <h3 className="text-2xl font-merriweather font-bold mb-3">Info Session</h3>
                        <div className="text-gray-600 mb-3">Location: TBD</div>
                        <p className="text-gray-700">
                          Learn about AEZ&apos;s professional pillars and discover our social events and opportunities.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="ml-16 flex-1">
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        <div className="text-[#3d0f19] font-bold text-sm mb-2">9/7 | 7:00 - 8:30 PM</div>
                        <h3 className="text-2xl font-merriweather font-bold mb-3">Meet and Greet</h3>
                ...
                <div className="ml-16 flex-1">
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        <div className="text-[#3d0f19] font-bold text-sm mb-2">9/11 - 9/12</div>
                ...
                <div className="ml-16 flex-1">
                  <div className="bg-white rounded-lg shadow-lg p-6">
                    <div className="flex items-start gap-6">
                      ...
                      <div className="flex-1">
                        <div className="text-[#3d0f19] font-bold text-sm mb-2">9/13</div>
